                    ...
                    <form action="Bidding.php" method="post">
                        <div>
                            ...
                            <input name="bidamount" class="bidbutton" type="number" id="bidValue"
                                placeholder="Enter the Bid Amount" style="height: 30px;" min="0">
                            <button class="bidbutton" onclick="placeBid()"
                                style="background-color:tomato;margin-left:-30px;">Bid</button> <!--bidding button-->
                        </div>
                    </form>
                    <h4>
                        <?php
...
?>
    ...
    <footer>
        ...
        <div class="footer2">
            ...
            <p><a href="contact_login.php">Contact Us</a></p>
